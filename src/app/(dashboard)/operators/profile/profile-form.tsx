// Operator Profile Form - Client component for editing profile
"use client";
...
export function OperatorProfileForm({ profile, userEmail }: OperatorProfileFormProps) {
      ...
      <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-2xl p-6 text-white">
        <div className="text-center">
          <div className="relative inline-block">
            ...
            <button className="absolute bottom-0 right-0 w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-emerald-900 hover:bg-yellow-400 transition-colors">
              <Camera size={16} />
            </button>
          </div>
          ...
          <p className="text-emerald-100 text-sm mt-2">{userEmail}</p>
        </div>

        <div className="mt-6 pt-6 border-t border-white/20 space-y-3">
          <div className="text-center text-sm pt-3">
            <p className="text-emerald-100">Member since</p>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-6 py-2.5 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
              >
                {isSubmitting ? (
                  <>
