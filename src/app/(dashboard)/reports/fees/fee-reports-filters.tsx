...
interface FeeReportsFiltersProps {
...
const reportTypes = [
  ...
  { value: "defaulters", label: "Fee Defaulters" },
];

export function FeeReportsFilters({ classOptions, currentFilters }: FeeReportsFiltersProps) {
  ...
  const updateFilter = (key: string, value: string) => {
    ...
    router.push(`/reports/fees?${params.toString()}`);
  };
